...
class NewsFragment : Fragment() {
    lateinit var adapterBerita: NewsAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listBerita = arrayListOf(
            DataNews(
                ...
                "CNN",
                R.drawable.munir,
                "Jakarta, CNN Indonesia -- Istri aktivis hak asasi manusia (HAM) Munir Said Thalib, Suciwati menilai tindakan hacker Bjorka yang membeberkan pelaku pembunuhan suaminya merupakan pesan penting.\n" +
            ...
            DataNews(
                "Harga Minyak Dunia Naik Lagi Nih, BBM Nggak Jadi Turun Dong?",
                "13 Sep 2022",
                "Zulfi Suhendra",
                R.drawable.minyak,
                "Jakarta - Harga minyak dunia pada hari ini naik. Kenaikan ini berlanjut karena investor masih khawatir dengan pasokan yang menipis jelang musim dingin.\n" +
            ...
            DataNews(
                "Muncul 'Kembaran' Jefri Nichol Kenakan Seragam Pramuka, Reaksi Sang Artis Tak Terduga",
                "14 September 2022",
                "Vania Ika Aldida",
                R.drawable.nichol,
                "AKTOR Jefri Nichol mendadak ramai dibicarakan oleh netizen di media sosial. Hal tersebut berawal dari unggahan akun @jakarta.keras, yang memposting sebuah foto pelajar menggunakan seragam pramuka.\n" +
                        "\n" +
            ...
            DataNews(
                "Beredar Pengisian Data BSU Melalui Sosmed, Kemenaker: Itu Hoaks",
                "14 September 2022",
                "Kompas.com",
                R.drawable.bsu,
            ...
            DataNews(
                "Polisi Antisipasi Demo BBM di Patung Kuda dan Flyover Pasar Rebo",
                "14 September 2022",
                "Zunita Putri",
                R.drawable.kuda,
                "Jakarta - Polda Metro Jaya menyiagakan personel untuk mengantisipasi demo penolakan kenaikan harga BBM. Hari ini, sekelompok elemen massa akan kembali turun demo di kawasan Patung Kuda dan Flyover Pasar Rebo.\n" +
            ...
            DataNews(
                "BSU 2022 Cair! Cek Namamu di bsu.bpjsketenagakerjaan.go.id",
                "14 September 2022",
                "Tim Redaksi, CNBC Indonesia",
                R.drawable.cair,
                "Jakarta, CNBC Indonesia - Pemerintah melalui Kementerian Ketenagakerjaan telah menyalurkan bantuan subsidi upah (BSU) sebesar Rp 600 ribu kepada 4,1 juta pekerja berpenghasilan maksimal Rp 3,5 juta per bulan pada awal pekan ini.\n" +
